...
const T = {
  es: {
    ...
    tabNet: "Neto",
    tabPipe: "Pipeline",
    pDailyMin: "Ganancia diaria mín",
    pDailyMax: "Ganancia diaria máx",
    pWithdraw: "Retiro por evento",
    pTrigger: "Trigger retiro (P&L)",
    pGraduate: "Retiros antes de ir a vivo",
    pAccs: "Total cuentas",
    pGoal: "Objetivo mensual",
    pLiveDaily: "Retiro diario en vivo",
    fmtGrad: v => `${v}° retiro`,
    fmtAccs: v => `${v} cuentas`,
    fmtH: v => `${v}h`,
    fmtPct: v => `${v}%`,
    kC1: "Ciclo 1",
    kC1s: "días primer retiro",
    kC2: "Ciclo 2+",
    kC2s: "días recurrente",
    kBuf: "Buffer post-retiro",
    kBufSuf: "del trigger",
    kFacc: "Fondeo/acc/mes",
    kLacc: "Vivo/acc/mes",
    kXF: "× fondeo",
    kXL: "× vivo",
    kUp: "Upgrade al ir a vivo",
    kSS: "estado estable",
    secFunded: "Fase Fondeada",
    secLive: "Fase En Vivo",
    rC1: "Ciclo 1 (sin buffer)",
    rC2: "Ciclo 2+ (con buffer)",
    rWAmt: "Retiro/ciclo",
    rBuf: "Buffer tras retiro",
    rInc1: "Income mes 1/acc",
    rInc2: "Income mes 2+/acc",
    rNeed: g => `Cuentas para ${fmtK(g)}/mes`,
    rLBuf: "Buffer a construir",
    rLDays: "Días building buffer",
    rLDay: "Retiro diario",
    rLI1: "Income mes 1/acc",
    ...
    vAvgLoss: "Pérdida media día malo",
    vDDDay: "DD diario límite",
    vDDTot: "DD total límite",
    vkBlown: "Cuentas reventadas",
    vkSurv: "Supervivencia",
    vkDays: "Días P50 (mediana)",
    vkVsP: "vs plan perfecto",
    vkP50: "Income P50",
    vkP10: "Income P10",
    vkP90: "Income P90",
    ...
    vP50: "P50 mediana",
    vP90: "P90 optimista",
    vRPerfect: "Escenario perfecto",
    vRMedian: "Mediana realista (P50)",
    ...
    nFee: "Fee evaluación/cuenta",
    nPlat: "Plataforma + datos/mes",
    ...
    kNetM: "Neto mensual",
    kNetA: "Neto anual",
    kHourly: "$/hora efectiva",
    kROI: "ROI sobre fees",
    kEffRate: "Tasa real total",
    kBE: "Break-even",
    ...
    pTotal: "Total cuentas",
    pInEval: "En evaluación",
    pInFund: "En fondeo",
    pInLive: "En vivo",
    pTotalInc: "Income total/mes",
    pVsGoal: "vs Meta",
    acPnl: "P&L ACTUAL",
    acW: "RETIROS",
    acCont: "CONTRIB/MES",
    acCycle: "Ciclo actual",
    acBuf: "Buffer",
    acProg: "Retiros → graduación",
    acDW: n => `~${n}d retiro`,
    acDL: n => `~${n}d → vivo`,
    acReady: "¡Listo para retirar!",
    acDayFmt: v => `${fmt(v)}/día`,
    acBufOk: "Buffer ✓",
    ...
    mPhL: "VIVO",
    mPnl: "P&L actual ($)",
    mWCount: "Retiros hechos",
    mGrad: "Retiros → vivo",
    mTrig: "Trigger ($)",
    mWAmt: "Retiro ($)",
    mTarget: "Objetivo diario",
    mColor: "Color",
    mSave: "GUARDAR",
    mCancel: "CANCELAR",
    ofGoal: "de meta",
    stableState: "estado estable",
    daysExtra: n => `+${n}d`,
    ...
    calcExplain: (c1, c2, tDays, wAmt, c1inc, c2inc, goal) => `Ciclo 1: ${c1}d → ${fmt(wAmt)}. Ciclos siguientes: ${c2}d → ${fmt(wAmt)}. En ${tDays} días hábiles: mes 1 genera ${fmt(c1inc)}/cuenta, mes 2+ genera ${fmt(c2inc)}/cuenta.`,
  ...
  en: {
    ...
    tabNet: "Net P&L",
    tabPipe: "Pipeline",
    pDailyMin: "Min daily gain",
    pDailyMax: "Max daily gain",
    pWithdraw: "Withdrawal / event",
    pTrigger: "Withdrawal trigger",
    pGraduate: "Withdrawals before live",
    pAccs: "Total accounts",
    pGoal: "Monthly goal",
    pLiveDaily: "Daily withdrawal (live)",
    fmtGrad: v => `${v} withdrawals`,
    fmtAccs: v => `${v} accounts`,
    fmtH: v => `${v}h`,
    fmtPct: v => `${v}%`,
    kC1: "Cycle 1",
    kC1s: "days to first withdrawal",
    kC2: "Cycle 2+",
    kC2s: "days recurring",
    kBuf: "Post-withdrawal buffer",
    kBufSuf: "of trigger",
    kFacc: "Funded/acc/mo",
    kLacc: "Live/acc/mo",
    kXF: "× funded",
    ...
    kUp: "Live upgrade",
    kSS: "steady state",
    secFunded: "Funded Phase",
    secLive: "Live Account Phase",
    rC1: "Cycle 1 (no buffer)",
    rC2: "Cycle 2+ (with buffer)",
    rWAmt: "Withdrawal/cycle",
    rBuf: "Buffer after withdrawal",
    rInc1: "Month 1 income/acc",
    rInc2: "Month 2+ income/acc",
    rNeed: g => `Accounts for ${fmtK(g)}/mo`,
    rLBuf: "Buffer to build",
    rLDays: "Days building buffer",
    rLDay: "Daily withdrawal",
    rLI1: "Month 1 income/acc",
    ...
    vAvgLoss: "Avg loss on bad days",
    vDDDay: "Daily DD limit",
    vDDTot: "Total DD limit",
    vkBlown: "Blown accounts",
    vkSurv: "Survival rate",
    vkDays: "Days P50 (median)",
    vkVsP: "vs perfect plan",
    vkP50: "Income P50",
    vkP10: "Income P10",
    vkP90: "Income P90",
    ...
    vP10: "P10 pessimistic",
    vP50: "P50 median",
    vP90: "P90 optimistic",
    vRPerfect: "Perfect scenario",
    vRMedian: "Realistic median (P50)",
    ...
    nTitle: "Costs & Tax",
    nFee: "Evaluation fee/account",
    nPlat: "Platform + data/month",
    ...
    kNetM: "Net monthly",
    kNetA: "Net annual",
    kHourly: "$/effective hour",
    kROI: "ROI on fees",
    kEffRate: "Total effective rate",
    kBE: "Break-even",
    ...
    pTotal: "Total accounts",
    pInEval: "In evaluation",
    pInFund: "Funded",
    pInLive: "Live",
    pTotalInc: "Total income/mo",
    pVsGoal: "vs Goal",
    acPnl: "CURRENT P&L",
    acW: "WITHDRAWALS",
    acCont: "CONTRIB/MO",
    acCycle: "Current cycle",
    acBuf: "Buffer",
    acProg: "Withdrawals → graduation",
    acDW: n => `~${n}d withdrawal`,
    acDL: n => `~${n}d → live`,
    acReady: "Ready to withdraw!",
    acDayFmt: v => `${fmt(v)}/day`,
    acBufOk: "Buffer ✓",
    ...
    mPhL: "LIVE",
    mPnl: "Current P&L ($)",
    mWCount: "Completed withdrawals",
    mGrad: "Withdrawals → live",
    mTrig: "Trigger ($)",
    mWAmt: "Withdrawal ($)",
    mTarget: "Daily target",
    mColor: "Color",
    mSave: "SAVE",
    mCancel: "CANCEL",
    ofGoal: "of goal",
    stableState: "steady state",
    daysExtra: n => `+${n}d`,
    ...
    calcExplain: (c1, c2, tDays, wAmt, c1inc, c2inc, goal) => `Cycle 1: ${c1}d → ${fmt(wAmt)}. Subsequent: ${c2}d → ${fmt(wAmt)}. In ${tDays} trading days: month 1 generates ${fmt(c1inc)}/account, month 2+ generates ${fmt(c2inc)}/account.`,
...
function runMC({
  ...
  for (let s = 0; s < N; s++) {
    ...
    while (withdrawals < graduateAt && days < 120) {
      ...
      let dayPnl;
      if (r < winRate) {
        dayPnl = dailyMin * 0.4 + Math.random() * (dailyMax * 1.6 - dailyMin * 0.4);
      } else if (r < winRate + (1 - winRate) * 0.60) {
        dayPnl = -(30 + Math.random() * avgLoss * 1.4);
      } else {
        dayPnl = -(avgLoss * 1.4 + Math.random() * (dailyDDLimit * 0.9 - avgLoss * 1.4));
      }
      if (dayPnl < -dailyDDLimit) {
        dayPnl = -dailyDDLimit;
        ddHits++;
        blown = true;
        break;
  ...
  const incomeHist = {},
    daysHist = {};
  survivors.forEach(r => {
    const ib = Math.floor(r.totalIncome / 500) * 500;
    incomeHist[ib] = (incomeHist[ib] || 0) + 1;
    const db = Math.floor(r.days / 5) * 5;
    daysHist[db] = (daysHist[db] || 0) + 1;
  });
  return {
    N,
    blown_n,
    blownPct: blown_n / N * 100,
    survivors: survivors.length,
    medianDays: p(sd, 50),
    p10Days: p(sd, 10),
    p90Days: p(sd, 90),
    medianIncome: p(si, 50),
    p10Income: p(si, 10),
    p90Income: p(si, 90),
    incomeHist,
    daysHist,
    totalDDEvents: results.reduce((s, r) => s + r.ddHits, 0)
  };
}
function Slider({
  label,
  ...
  }, fmtFn(value))), React.createElement("div", {
    style: {
      position: "relative",
      height: 4,
      background: C.dim,
...
function Histogram({
  ...
  if (!entries.length) return React.createElement("div", {
    style: {
      height: 70,
      display: "flex",
      alignItems: "center",
...
function AccountCard({
  ...
  }, acc.firm))), React.createElement("div", {
    style: {
      display: "flex",
      gap: 5,
      alignItems: "center"
    }
  }, React.createElement(PhaseBadge, {
    phase: acc.phase,
    t: t
  ...
  }, t.acPnl), React.createElement("div", {
    style: {
      fontSize: 22,
      fontWeight: 800,
      fontFamily: "monospace",
      color: acc.currentPnl >= 0 ? C.green : C.red
    }
  }, fmt(acc.currentPnl))), React.createElement("div", {
    style: {
      textAlign: "right"
    }
  }, React.createElement("div", {
  ...
  }, acc.phase === "funded" ? t.acW : t.acCont), React.createElement("div", {
    style: {
      fontSize: 22,
      fontWeight: 800,
      fontFamily: "monospace",
  ...
  }, acc.phase === "funded" ? t.retiroOf(acc.withdrawalCount, acc.graduateAt) : fmtK(mc)))), acc.phase !== "eval" && React.createElement(React.Fragment, null, React.createElement("div", {
    style: {
      marginBottom: 6
    }
  }, React.createElement("div", {
  ...
  }, React.createElement("span", null, acc.phase === "funded" ? t.acCycle : t.acBuf), React.createElement("span", null, cycleP.toFixed(0), "%")), React.createElement("div", {
    style: {
      height: 4,
      background: C.dim,
      borderRadius: 2
  ...
  }))), acc.phase === "funded" && React.createElement("div", {
    style: {
      marginBottom: 8
    }
  }, React.createElement("div", {
  ...
  }, React.createElement("span", null, t.acProg), React.createElement("span", null, wP.toFixed(0), "%")), React.createElement("div", {
    style: {
      height: 4,
      background: C.dim,
      borderRadius: 2
  ...
  }, acc.phase === "funded" && daysToNext > 0 && React.createElement(Tag, {
    color: C.gold
  }, t.acDW(daysToNext)), acc.phase === "funded" && daysToGrad > 0 && React.createElement(Tag, {
    color: C.orange
  }, t.acDL(daysToGrad)), acc.phase === "funded" && acc.currentPnl >= acc.triggerPnl && React.createElement(Tag, {
    color: C.green
  }, t.acReady), acc.phase === "live" && React.createElement(Tag, {
    color: C.green
  }, t.acDayFmt(acc.dailyTarget)), acc.phase === "live" && daysToNext === 0 && React.createElement(Tag, {
    color: C.green
  }, t.acBufOk), acc.phase === "eval" && React.createElement(Tag, {
    color: C.blue
  }, t.acInEval)));
}
function EditModal({
  ...
  const field = (label, key, type = "text") => React.createElement("div", {
    key: key,
    style: {
      marginBottom: 11
    }
  ...
  }, t.mTitle), React.createElement("button", {
    onClick: onClose,
    style: {
      background: "none",
      border: `1px solid ${C.border}`,
  ...
  }, "✕")), field(t.mName, "name"), React.createElement("div", {
    style: {
      marginBottom: 11
    }
  }, React.createElement("div", {
  ...
  }, t.mFirm), React.createElement("select", {
    value: f.firm,
  ...
  }, FIRMS.map(x => React.createElement("option", {
    key: x
  ...
  }, t.mPhase), React.createElement("div", {
    style: {
      display: "flex",
      gap: 6
    }
  }, ["eval", "funded", "live"].map(p => {
    const [l, c] = phaseMap[p];
    return React.createElement("div", {
      key: p,
      onClick: () => set("phase", p),
      style: {
        ...
        textAlign: "center",
        cursor: "pointer",
        border: `1px solid ${f.phase === p ? c : C.border}`,
        background: f.phase === p ? c + "18" : "transparent",
        borderRadius: 6,
        fontSize: 11,
        fontWeight: 700,
        color: f.phase === p ? c : C.muted
      }
    }, l);
  }))), React.createElement("div", {
    className: "gform"
  }, [[t.mPnl, "currentPnl", "number"], [t.mWCount, "withdrawalCount", "number"], [t.mGrad, "graduateAt", "number"], [t.mTrig, "triggerPnl", "number"], [t.mWAmt, "withdrawAmt", "number"], [t.mTarget, "dailyTarget", "number"]].map(([l, k, tp]) => field(l, k, tp))), React.createElement("div", {
    style: {
      marginBottom: 14
    }
  }, React.createElement("div", {
  ...
  }, t.mColor), React.createElement("div", {
    style: {
      display: "flex",
      gap: 8,
      flexWrap: "wrap"
    }
  }, ACC_COLORS.map(c => React.createElement("div", {
    key: c,
    onClick: () => set("color", c),
    style: {
      width: 22,
  ...
  }, t.mSave), React.createElement("button", {
    onClick: onClose,
    style: {
      background: "none",
      border: `1px solid ${C.border}`,
...
function App() {
  ...
  const accsM1 = Math.ceil(monthGoal / month1Fund);
  const accsM2 = Math.ceil(monthGoal / month2Fund);
  const accsRec = Math.max(accsM1, accsM2);
  const liveBuffDays = Math.ceil(liveBuffer / liveWithdraw);
  const month2Live = tradingDays * liveWithdraw;
  const accsLive = Math.ceil(monthGoal / month2Live);
  ...
  const saveAcc = a => {
    setAccounts(p => p.find(x => x.id === a.id) ? p.map(x => x.id === a.id ? a : x) : [...p, a]);
    setEditingAcc(null);
  };
  const TABS = [{
    k: "sistema",
...
@media(max-width:480px){
  .g3{grid-template-columns:1fr!important}
}`), editingAcc && React.createElement(EditModal, {
    acc: editingAcc,
    onSave: saveAcc,
  ...
  }, t.langBtn)), React.createElement("div", {
    style: {
      display: "flex",
      gap: 5,
      alignItems: "center",
  ...
  }, t.enFondeo), React.createElement("div", {
    style: {
      fontSize: 36,
      fontWeight: 800,
      color: C.gold,
  ...
  }, accsRec), React.createElement("div", {
    style: {
      fontSize: 10,
      color: C.muted,
      marginTop: 2
    }
  }, fmtK(stableFund), "/mes")), React.createElement("div", {
    style: {
      fontSize: 18,
      color: C.dim,
      alignSelf: "center"
  ...
  }, t.enVivo), React.createElement("div", {
    style: {
      fontSize: 36,
      fontWeight: 800,
      color: C.green,
  ...
  }, accsLive), React.createElement("div", {
    style: {
      fontSize: 10,
      color: C.muted,
      marginTop: 2
    }
  }, fmtK(accsLive * month2Live), "/mes")), [{
    l: t.hNet,
    v: fmtK(monthlyNet),
    c: C.teal
  }, {
    l: t.hPipeline,
    v: fmtK(pipelineIncome),
    c: C.blue
  }].map(({
    l,
    v,
    ...
    step: 25,
    value: dailyMin,
    onChange: v => setDailyMin(Math.min(v, dailyMax - 25)),
    color: C.gold
  }), React.createElement(Slider, {
    label: t.pDailyMax,
    min: 150,
    ...
    step: 25,
    value: dailyMax,
    onChange: v => setDailyMax(Math.max(v, dailyMin + 25)),
    color: C.gold
  }), React.createElement(Slider, {
    label: t.pWithdraw,
    min: 800,
  ...
  }, TABS.map(tb => React.createElement("div", {
    key: tb.k,
    onClick: () => setTab(tb.k),
    style: {
      padding: "9px 22px",
      ...
      letterSpacing: "0.5px",
      cursor: "pointer",
      color: tab === tb.k ? C.green : C.muted,
      borderBottom: `2px solid ${tab === tb.k ? C.green : "transparent"}`,
      transition: "all .15s",
      textTransform: "uppercase",
      whiteSpace: "nowrap"
    }
  }, tb.l))), tab === "sistema" && React.createElement("div", null, React.createElement("div", {
    style: {
      background: "linear-gradient(135deg,#0c0f1a,#0a1020)",
  ...
  }, t.paraLlegar, " ", React.createElement("span", {
    style: {
      color: "#fff",
      fontFamily: "monospace"
    }
  }, fmtK(monthGoal)), "/mes, ", t.necesitas, ":"), React.createElement("div", {
    style: {
      display: "flex",
      gap: 12,
      justifyContent: "center",
  ...
  }, t.recFunded), React.createElement("div", {
    style: {
      fontSize: 72,
      fontWeight: 800,
      color: C.gold,
  ...
  }, "× ", fmt(month2Fund), "/mes"), React.createElement("div", {
    style: {
      fontSize: 14,
      fontWeight: 700,
      color: C.gold,
  ...
  }, "= ", fmt(stableFund), "/mes"), React.createElement("div", {
    style: {
      marginTop: 10,
      padding: "6px 10px",
      background: C.gold + "15",
  ...
  }, t.mesInicio, ": ", React.createElement("span", {
    style: {
      color: C.gold
    }
  }, fmt(month1Fund))), React.createElement("div", {
    style: {
      fontSize: 10,
      color: C.muted
    }
  }, t.mesEstable, ": ", React.createElement("span", {
    style: {
      color: C.gold
    }
  }, fmt(month2Fund))))), React.createElement("div", {
    style: {
      display: "flex",
  ...
  }, graduateMonth, " ", lang === "es" ? "meses" : "months")), React.createElement("div", {
    style: {
  ...
  }, t.recLive), React.createElement("div", {
    style: {
      fontSize: 72,
      fontWeight: 800,
      color: C.green,
  ...
  }, "× ", fmt(month2Live), "/mes"), React.createElement("div", {
    style: {
      fontSize: 14,
      fontWeight: 700,
      color: C.green,
  ...
  }, "= ", fmt(accsLive * month2Live), "/mes"), React.createElement("div", {
    style: {
      marginTop: 10,
      padding: "6px 10px",
      background: C.green + "10",
  ...
  }, lang === "es" ? "Retiro diario" : "Daily withdrawal", ": ", React.createElement("span", {
    style: {
      color: C.green
    }
  }, fmt(liveWithdraw), "/día")))), React.createElement("div", {
    style: {
      background: "#0a0a14",
      border: `1px solid ${C.border}`,
      borderRadius: 10,
  ...
  }, t.howCalc), [[t.accsM1label, `⌈${fmtK(monthGoal)} ÷ ${fmt(month1Fund)}⌉ = ${accsM1}`, C.muted], [t.accsM2label, `⌈${fmtK(monthGoal)} ÷ ${fmt(month2Fund)}⌉ = ${accsM2}`, C.muted], [t.accsRecLabel, `max(${accsM1}, ${accsM2}) = ${accsRec}`, C.gold]].map(([l, v, c]) => React.createElement("div", {
    key: l,
    style: {
      marginBottom: 8,
      paddingBottom: 8,
  ...
  }, t.calcExplain(c1Days, c2Days, tradingDays, withdrawAmt, month1Fund, month2Fund, monthGoal))))), React.createElement("div", {
    style: {
      display: "grid",
    ...
    v: fmt(bufferAfter),
    c: C.purple,
    s: `${(bufferAfter / triggerPnl * 100).toFixed(0)}% ${t.kBufSuf}`
  }, {
    l: t.kFacc,
    v: fmt(month2Fund),
    c: C.gold,
    s: `${Math.floor(tradingDays / c2Days)} retiros`
  }, {
    l: t.kLacc,
    v: fmt(month2Live),
    c: C.green,
    s: `${tradingDays}d × ${fmt(liveWithdraw)}`
  }, {
    l: `${accsRec} ${t.kXF}`,
    v: fmt(stableFund),
    c: C.gold,
    ...
    title: t.secFunded,
    color: C.gold,
    rows: [[t.rC1, `${c1Days}d`], [t.rC2, `${c2Days}d`], [t.rWAmt, fmt(withdrawAmt)], [t.rBuf, fmt(bufferAfter)], [t.rInc1, fmt(month1Fund)], [t.rInc2, fmt(month2Fund)], [t.rNeed(monthGoal), `${accsRec} ${lang === "es" ? "cuentas" : "accounts"}`]]
  }, {
    title: t.secLive,
    color: C.green,
    rows: [[t.rLBuf, fmt(liveBuffer)], [t.rLDays, `${Math.round(liveBuffDays)}d`], [t.rLDay, fmt(liveWithdraw)], [t.rLI1, fmt(Math.max(0, tradingDays - liveBuffDays) * liveWithdraw)], [t.rLI2, fmt(month2Live)], [t.rLUp, `+${liveUpgradePct}%`], [t.rNeed(monthGoal), `${accsLive} ${lang === "es" ? "cuentas" : "accounts"}`]]
  }].map(({
    title,
    color,
    rows
  ...
  }, title), rows.map(([l, v]) => React.createElement(Row, {
    key: l,
    label: l,
    value: v,
    color: color
  ...
  }, t.sysNote(accsRec, stableLive, monthlyNet, effectiveHourly, roiAnnual, monthGoal, graduateMonth + 2))), tab === "varianza" && React.createElement("div", null, React.createElement("div", {
    style: {
      background: C.card,
      border: `1px solid ${C.border}`,
      borderRadius: 10,
  ...
  }, t.vTitle), React.createElement("button", {
    onClick: runSim,
    disabled: simRunning,
    style: {
      background: C.blue,
  ...
  }, simRunning ? t.vRunning : t.vRun)), React.createElement("div", {
    style: {
      display: "grid",
      gridTemplateColumns: "repeat(auto-fill,minmax(210px,1fr))",
      gap: "2px 22px"
    ...
    step: 500,
    value: totalDDLimit,
    onChange: setTotalDDLimit,
    color: C.orange
  }))), simRes ? React.createElement(React.Fragment, null, React.createElement("div", {
    style: {
      display: "grid",
      gridTemplateColumns: "repeat(auto-fill,minmax(130px,1fr))",
      gap: 10,
    ...
    l: t.vkBlown,
    v: `${simRes.blownPct.toFixed(1)}%`,
    c: simRes.blownPct < 5 ? C.green : simRes.blownPct < 15 ? C.gold : C.red,
    s: t.blownOf(simRes.blown_n, 500)
  }, {
    l: t.vkSurv,
    v: `${(100 - simRes.blownPct).toFixed(1)}%`,
    c: C.green,
    s: ""
  }, {
    l: t.vkDays,
    v: `${Math.round(simRes.medianDays)}d`,
    c: C.blue,
    s: `P10:${simRes.p10Days}d · P90:${simRes.p90Days}d`
  }, {
    l: t.vkVsP,
    v: t.daysExtra(simRes.medianDays - fundedTradeDays),
    c: C.muted,
    s: ""
  }, {
    l: t.vkP50,
    v: fmt(simRes.medianIncome),
    c: C.gold,
    s: ""
  }, {
    l: t.vkP10,
    v: fmt(simRes.p10Income),
    c: C.red,
    s: ""
  }, {
    l: t.vkP90,
    v: fmt(simRes.p90Income),
    c: C.green,
    s: ""
  }, {
    l: t.vkEvt,
    v: simRes.totalDDEvents,
    c: C.orange,
    s: ""
  }].map(({
    l,
  ...
  }, t.vH1), React.createElement(Histogram, {
    data: simRes.incomeHist,
    color: C.gold
  }), React.createElement("div", {
    className: "g3",
    style: {
  ...
  }, [[t.vP10, simRes.p10Income, C.red], [t.vP50, simRes.medianIncome, C.gold], [t.vP90, simRes.p90Income, C.green]].map(([l, v, c]) => React.createElement("div", {
    key: l,
    style: {
      textAlign: "center",
      padding: "10px 8px",
  ...
  }, t.vH2), React.createElement(Histogram, {
    data: simRes.daysHist,
    color: C.blue
  }), React.createElement("div", {
    style: {
      marginTop: 12
    ...
    label: t.vRPerfect,
    value: `${fundedTradeDays}d`,
    color: C.green
  }), React.createElement(Row, {
    label: t.vRMedian,
    value: `${Math.round(simRes.medianDays)}d`,
    color: C.gold
  }), React.createElement(Row, {
    label: t.vRHard,
    value: `${Math.round(simRes.p90Days)}d`,
    color: C.red
  }), React.createElement(Row, {
    label: t.vRMargin,
    value: t.daysExtra(simRes.medianDays - fundedTradeDays),
    color: C.muted
  })))), React.createElement("div", {
    style: {
      background: simRes.blownPct < 10 ? C.green + "08" : C.red + "08",
      border: `1px solid ${simRes.blownPct < 10 ? C.green : C.red}25`,
      borderRadius: 8,
      padding: "12px 16px",
      fontSize: 13,
      color: C.muted,
  ...
  }, t.vNote(simRes.blownPct, Math.round(winRate * 100), avgLoss, simRes.medianIncome, graduateAt * withdrawAmt, evalFee))) : React.createElement("div", {
    style: {
      background: C.card,
      border: `1px solid ${C.border}`,
      borderRadius: 10,
  ...
  }, simRunning ? t.vRunning : t.vNoSim)), tab === "riesgo" && React.createElement("div", null, !simRes && React.createElement("div", {
    style: {
  ...
  }, t.rkNoSim), React.createElement("div", {
    className: "g2",
    style: {
      marginBottom: 14
    }
  ...
  }, t.rkTitle), simRes ? React.createElement(React.Fragment, null, React.createElement("div", {
    style: {
      textAlign: "center",
      marginBottom: 14
    }
  ...
  }, t.rkProb), React.createElement("div", {
    style: {
      fontSize: 48,
      fontWeight: 800,
      fontFamily: "monospace",
      color: simRes.blownPct < 5 ? C.green : simRes.blownPct < 15 ? C.gold : C.red,
      lineHeight: 1
    }
  }, simRes.blownPct.toFixed(1), "%")), React.createElement("div", {
    style: {
      height: 7,
      background: C.dim,
      borderRadius: 4,
    ...
    style: {
      height: "100%",
      width: `${Math.min(simRes.blownPct, 100)}%`,
      background: simRes.blownPct < 5 ? C.green : simRes.blownPct < 15 ? C.gold : C.red,
      borderRadius: 4
    }
  })), [[t.rkSurv, `${(100 - simRes.blownPct).toFixed(1)}%`, C.green], [t.rkBY, `${(simRes.blownPct / 100 * accsRec * (12 / Math.max(1, fundedTradeDays / tradingDays))).toFixed(1)}`, C.red], [t.rkCost, fmt(evalFee), C.gold], [t.rkCostY, fmt(simRes.blownPct / 100 * accsRec * (12 / Math.max(1, fundedTradeDays / tradingDays)) * evalFee), C.orange], [t.rkInc, fmt(simRes.medianIncome), C.green], [t.rkRatio, `${(simRes.medianIncome / evalFee).toFixed(0)}× ${lang === "es" ? "el fee" : "the fee"}`, C.green]].map(([l, v, c]) => React.createElement(Row, {
    key: l,
    label: l,
    value: v,
    color: c
  ...
  }, t.rkDDTitle), [[t.rkAvail, fmt(dailyDDLimit), C.red], [t.rkTarget, fmt(dailyAvg), C.green], [t.rkUse, `${(dailyAvg / dailyDDLimit * 100).toFixed(0)}%`, C.gold], [t.rkMargin, fmt(dailyDDLimit - dailyAvg), C.green], [t.rkToDD, t.consecutiveL(Math.ceil(dailyDDLimit / avgLoss)), C.orange], [t.rkToTot, t.consecutiveL(Math.ceil(totalDDLimit / avgLoss)), C.red], [t.rkTrades, t.consecutiveL(Math.ceil(dailyDDLimit / 160)), C.orange]].map(([l, v, c]) => React.createElement(Row, {
    key: l,
    label: l,
    value: v,
    color: c
  ...
  }, t.rkNote(Math.ceil(dailyDDLimit / 160), avgLoss)))), React.createElement("div", {
    style: {
      background: C.card,
      border: `1px solid ${C.border}`,
      borderRadius: 10,
    ...
    l: t.rkROI,
    v: `${roiAnnual.toFixed(0)}%`,
    c: C.green
  }, {
    l: t.rkBreak,
    v: `${breakEvenMonths.toFixed(1)}m`,
    c: C.blue
  }, {
    l: t.rkRatioPort,
  ...
  }, t.rkPortNote(evalFee * accsRec, breakEvenMonths, simRes ? simRes.blownPct : 5)))), tab === "neto" && React.createElement("div", {
    className: "gneto"
  }, React.createElement("div", {
    style: {
      background: C.card,
  ...
  }, t.nTitle), React.createElement(Slider, {
    label: t.nFee,
    min: 100,
    max: 800,
    step: 25,
  ...
  }, t.nNote)), React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: 12
  ...
  }, t.nBreak, " (", accsRec, " ", lang === "es" ? "cuentas" : "accounts", ")"), [{
    l: t.nGross,
    v: stableLive,
    c: C.green,
    bar: 1.0
  }, {
    l: t.nFeeRow(monthlyEvalAmort),
    v: -monthlyEvalAmort,
    c: C.red,
    bar: monthlyEvalAmort / stableLive
  }, {
    l: t.nPlatRow(platformCost),
    v: -platformCost,
    c: C.red,
    bar: platformCost / stableLive
  }, {
    l: t.nOthRow(otherCost),
    v: -otherCost,
    c: C.red,
    bar: otherCost / stableLive
  }, {
    l: t.nTaxBase,
    v: monthlyTaxable,
    c: C.gold,
    bar: monthlyTaxable / stableLive,
    div: true
  }, {
    l: t.nTaxRow(taxRate),
    v: -monthlyTax,
    c: C.red,
    bar: monthlyTax / stableLive
  }, {
    l: t.nNetRow,
    v: monthlyNet,
    c: C.teal,
    bar: monthlyNet / stableLive,
    big: true
  }].map(({
    l,
    v,
    ...
    style: {
      ...
      justifyContent: "space-between",
      alignItems: "center",
      padding: `${big ? "12px" : "7px"} 0`,
      borderBottom: big ? `1px solid ${C.border}` : "none"
    }
  }, React.createElement("span", {
    style: {
      fontSize: big ? 13 : 11,
      color: big ? "#fff" : C.muted,
    ...
    style: {
      width: Math.round(clamp(bar, 0, 1) * 100),
      height: 4,
      background: c + "70",
      borderRadius: 2,
      minWidth: 2,
  ...
  }, v >= 0 ? "+" : "", fmt(Math.abs(v)))))))), React.createElement("div", {
    style: {
      display: "grid",
    ...
    l: t.kNetA,
    v: fmtK(monthlyNet * 12),
    c: C.teal,
    s: ""
  }, {
    l: t.kHourly,
    v: fmt(effectiveHourly),
    c: C.green,
    s: `${hoursPerDay}h × ${tradingDays}d`
  }, {
    l: t.kROI,
    v: `${roiAnnual.toFixed(0)}%`,
    c: C.green,
    ...
    l: t.kEffRate,
    v: `${((1 - monthlyNet / stableLive) * 100).toFixed(0)}%`,
    c: C.muted,
    s: ""
  }, {
    l: t.kBE,
    ...
    color: c,
    accent: c + "30"
  }))))), tab === "pipeline" && React.createElement("div", null, React.createElement("div", {
    style: {
      background: C.card,
      border: `1px solid ${C.border}`,
      borderRadius: 10,
  ...
  }, t.pIncLabel, " "), React.createElement("span", {
    style: {
      fontSize: 18,
      fontWeight: 800,
      fontFamily: "monospace",
      color: pipelineIncome >= monthGoal ? C.green : C.gold
    }
  }, fmtK(pipelineIncome)), React.createElement("span", {
    style: {
      fontSize: 11,
      color: C.muted,
      marginLeft: 6
    }
  }, pipelineIncome >= monthGoal ? "✓" : "", " ", (pipelineIncome / monthGoal * 100).toFixed(0), "% ", t.ofGoal))), React.createElement("button", {
    onClick: () => setEditingAcc(newAcc()),
    style: {
      background: C.green,
      border: "none",
      color: "#05050d",
  ...
  }, t.pAdd)), accounts.length === 0 ? React.createElement("div", {
    style: {
      background: C.card,
      border: `1px solid ${C.border}`,
      borderRadius: 10,
  ...
  }, t.pEmpty) : React.createElement("div", {
    style: {
      display: "grid",
  ...
  }, accounts.map(acc => React.createElement(AccountCard, {
    key: acc.id,
    acc: acc,
  ...
  }, t.pSummary), React.createElement("div", {
    style: {
      display: "grid",
    ...
    l: t.pInEval,
    v: accounts.filter(a => a.phase === "eval").length,
    c: C.blue
  }, {
    l: t.pInFund,
    v: accounts.filter(a => a.phase === "funded").length,
    c: C.gold
  }, {
    l: t.pInLive,
    v: accounts.filter(a => a.phase === "live").length,
    c: C.green
  }, {
    l: t.pTotalInc,
    v: fmtK(pipelineIncome),
    ...
    l: t.pVsGoal,
    v: `${(pipelineIncome / monthGoal * 100).toFixed(0)}%`,
    c: pipelineIncome >= monthGoal ? C.green : C.gold
  }].map(({
    l,
    v,
    c
